(function(window){
  ...
  var Recorder = function(source, source2, cfg){
    var config = cfg || {};
    //var bufferLen = config.bufferLen || 8192;
    var bufferLen = config.bufferLen || 4096;
    console.log("modified bufferLen=" + bufferLen);
    ...
    this.node.onaudioprocess = function(e){
      //config.onEvent(MSG_INIT_RECORDER, 'onaudioprocess()');
      if (!recording) return;
    ...
    this.clear2 = function(){
      worker.postMessage({ command: 'clear2' });
    }
